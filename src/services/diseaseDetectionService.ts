...
// Pre-packaged high quality agricultural sample cases for demonstration & offline mode
export const DEMO_DISEASE_SAMPLES: DiseaseAnalysisResult[] = [
  {
...
export const analyzeCropDiseaseImage = async (
  ...
  if (apiKey && apiKey.trim() !== '') {
    try {
      // Call Gemini 1.5 / Flash Vision model if key is configured
            ...
            parts: [
              {
                text: `You are an expert Indian plant pathologist. Analyze this crop leaf photo and return a strict JSON object with these keys:
                {
                  ...
                  "symptomsHindi": ["सymptom 1 in Hindi", "symptom 2 in Hindi"],
  ...
  // Fallback demo result selector based on image or demo index
